...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: "linear-gradient(135deg, #fdf8f0 0%, #fce4ec 50%, #e8f5e9 100%)" }}>
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 text-5xl float-animation">⭐</div>
      <div className="absolute bottom-20 right-10 text-5xl float-animation" style={{ animationDelay: "1s" }}>🌙</div>
      <div className="absolute top-1/2 left-5 text-3xl float-animation" style={{ animationDelay: "2s" }}>🌸</div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold" style={{ color: "#3d2b1f" }}>Welcome back!</h1>
          <p className="text-sm mt-1" style={{ color: "#8b5e3c" }}>Sign in to see your stories</p>
        </div>
        ...
        <div className="rounded-3xl p-8 shadow-xl" style={{ background: "white", boxShadow: "0 20px 60px rgba(61, 43, 31, 0.1)" }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-full text-white font-bold text-base transition-all hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed"
          ...
          <button
            ...
            style={{ border: "2px solid #f0e6d3", color: "#3d2b1f", background: "white" }}
          >
          ...
          <p className="text-center text-sm mt-6" style={{ color: "#8b5e3c" }}>
            ...
            <Link href="/signup" className="font-bold hover:underline" style={{ color: "#e8834a" }}>
              Sign up free
            </Link>
          </p>
        </div>
